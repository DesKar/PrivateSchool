...
public class SyntheticSchool extends School {
    ...
    private void addSchoolCoursesToSchool() {
        ...
        SchoolCourse schoolCourseOne = new SchoolCourse(firstCourse);
        schoolCourseOne.getStudents().addAll(selectedStudentsForFirstCourse);
        schoolCourseOne.getTrainers().addAll(selectedTrainersForFirstCourse);
        schoolCourseOne.getAssignments().addAll(selectedAssignmentsForFirstCourse);
        super.addSchoolCourseToSchoolCourses(schoolCourseOne);
        ...
        SchoolCourse schoolCourseTwo = new SchoolCourse(secondCourse);
        schoolCourseTwo.getStudents().addAll(selectedStudentsForSecondCourse);
        schoolCourseTwo.getTrainers().addAll(selectedTrainersForSecondCourse);
        schoolCourseTwo.getAssignments().addAll(selectedAssignmentsForSecondCourse);
        super.addSchoolCourseToSchoolCourses(schoolCourseTwo);
    }
}
